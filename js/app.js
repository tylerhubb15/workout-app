...
// ── Plan Type Switching (Weekly vs Cycle) ────────────────
...
function updateCyclePatternPreview() {
  ...
  preview.innerHTML = `<strong>Pattern (${cycleLength} days):</strong> ${pattern.join(" → ")} → repeats`;
}
    ...
    <div class="plan-day-card">
      ...
      <div class="plan-day-card-body"${isOpen ? "" : " hidden"}>
        <div class="plan-day-shortcuts">
          ...
          <button class="btn btn-secondary btn-sm" onclick="openCycleDayCopyMenu(${i})">Copy From…</button>
